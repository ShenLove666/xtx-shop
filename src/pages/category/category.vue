...
<template>
  ...
  <view class="viewport" v-else>
    ...
    <view class="categories">
      ...
      <!-- 右侧：二级分类 -->
      <scroll-view class="secondary" scroll-y v-for="(category, index) in categoryList" v-show="index === activeIndex"
        :key="category.id">
        <!-- 焦点图 -->
        <XtxSwiper class="banner" :list="bannerList" />
        <!-- 内容区域 -->
        <view class="panel" v-for="item in category.children">
          <view class="title">
            <text class="name">{{ item.name }}</text>
