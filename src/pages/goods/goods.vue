...
const selectedAddress = computed(() => {
  return addressStore.selectedAddress || addressStore.allAddress.find(v => v.isDefault)
})
...
onLoad(async () => {
  ...
  if (!addressStore.allAddress.length) {
...
<template>
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper @change="onChange" circular>
          <swiper-item v-for="pic in goods?.mainPictures" :key="pic">
      ...
      <uni-popup ref="popup" type="bottom" background-color="white">
        <ServicePannel v-if="popupName === 'service'" @close="popup?.close()" />
      ...
      <view class="action">
        <view class="item arrow">
          ...
          <text @tap="openSkuPopup(SkuMode.Both)" class="text ellipsis"> {{ selectedArrText }} </text>
        </view>
        <view @tap="openPopup('address')" class="item arrow">
          <text class="label">送至</text>
          <text class="text ellipsis" v-if="!selectedAddress"> 请选择收获地址 </text>
          <text class="text ellipsis" v-else> {{ selectedAddress.fullLocation }} </text>
        </view>
  ...
  <!-- 用户操作 -->
  <view v-if="isFinished" class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
