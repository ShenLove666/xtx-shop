...
import { getMemberProfileAPI, putMemeberProfileAPI } from '@/services/profile'
...
const onSubmit = async () => {
  ...
  const res = await putMemeberProfileAPI({
    nickname,
    gender,
    birthday,
...
const onGenderChange: UniHelper.RadioGroupOnChange = (ev) => {
  profile.value.gender = ev.detail.value as Gender // as 为 类型断言
}
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <radio-group @change="onGenderChange">
            <label class="radio">
              <radio value="男" color="#27ba9b" :checked="profile?.gender !== '女'" />
              男
            </label>
            <label class="radio">
