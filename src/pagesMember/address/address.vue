...
const getMemeberAddress = async () => {
  isFinished.value = false
  await addressStore.getAllAddress()
  addressList.value = addressStore.allAddress
...
<template>
  <view class="viewport">
    ...
    <scroll-view class="scroll-view" scroll-y>
      <view v-if="!isFinished || addressList.length" class="address">
        <uni-swipe-action class="address-list">
          <!-- 收货地址项 -->
          <uni-swipe-action-item class="item" @tap="onChangeAddress(item)" v-for="item in addressList" :key="item.id">
