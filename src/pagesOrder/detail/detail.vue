...
import { deleteMemberOrderAPI, getMemberOrderByIdAPI, getMemberOrderConsignmentAPI, getMemberOrderLogisticsByIdAPI, putMemberOrderReceiptByIdAPI } from '@/services/order'
      ...
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-else>
          ...
          <view class="button-group">
            ...
            <!-- 待收货状态：展示确认收获按钮 -->
            <view v-if="isDev && order.orderState === OrderState.DaiShouHuo" class="button" @tap="onOrderConfirm"> 确认收货
            </view>
          </view>
        </template>
      </view>
